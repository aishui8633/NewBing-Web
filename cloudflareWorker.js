...
let webPath = 'https://raw.githubusercontent.com/aishui8633/NewBing-Web/master/src/main/resources'; //web页面地址，可以修改成自己的仓库来自定义前端页面
let serverConfig = {
    "h1": "NewBing",
    "h2": "快速开始和NewBing聊天",
    "p":"",
...
async function handleRequest(request) {
    ...
    return getRedirect('/web/NewBing.html');
}
...
async function goUrl(request, url, addHeaders) {
    ...
    let cookieID = 0;
    if(reqHeaders.get('NewBingWeb')){//如果是web版
        //添加配置的随机cookie
        if (cookies.length === 0) {
