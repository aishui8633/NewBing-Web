...
public class NewBingServer extends NanoWSD {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            new NewBingServer(porint).start(5000,false);
        }catch(Throwable s){
            s.printStackTrace();
        }
    }
    public NewBingServer(int port) {
        super(port);
    }
 ...
 //           /641f0e9c318346378e94e495ab61a703?q=a+dog&partner=sydney&showselective=1
        ...
        return redirectTo("/web/NewBing.html");
    }
    ...
    protected WebSocket openWebSocket(IHTTPSession handshake) {
        ...
        if(url.equals("/sydney/ChatHub")){
            ...
            return new NewBingServerWebSocket(handshake,httpHeaders,scheduledExecutorService);
        }
    ...
    public static Response getReturnError(String message,Throwable error,boolean all){
        ...
        res.addHeader("NewBingError","true");
        return res;
    }
